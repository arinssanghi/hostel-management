...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment1 
   ...
   BeginProperty Recordset4 
      ...
      CommDispId      =   1033
      RsDispId        =   1037
      CommandText     =   "SELECT HostelName, RoomNumber, Capacity, Allocated FROM Hostels WHERE (Allocated = 0)"
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
   ...
   BeginProperty Recordset5 
      ...
      CommDispId      =   1038
      RsDispId        =   1042
      CommandText     =   "SELECT HostelName, RoomNumber, Capacity, Allocated FROM Hostels WHERE (Allocated = Capacity)"
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
   ...
   BeginProperty Recordset9 
      ...
      CommDispId      =   1051
      RsDispId        =   1062
      CommandText     =   "SELECT MatricNumber, LastName, FirstName, Department, tblLevel FROM StudentInfo"
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "byDept_Grouping"
      SummaryExpanded =   -1  'True
      DetailExpanded  =   -1  'True
      IsRSReturning   =   -1  'True
      NumFields       =   5
   ...
   BeginProperty Recordset10 
      ...
      CommDispId      =   1063
      RsDispId        =   1067
      CommandText     =   "SELECT MatricNumber, LastName, FirstName, Department, tblLevel, Sex FROM StudentInfo WHERE Sex = 'Female'"
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command9_Grouping"
      Expanded        =   -1  'True
      IsRSReturning   =   -1  'True
      NumFields       =   6
      BeginProperty Field1 
   ...
   BeginProperty Recordset11 
      ...
      CommDispId      =   1068
      RsDispId        =   1072
      CommandText     =   "SELECT MatricNumber, LastName, FirstName, Department, tblLevel, Special FROM StudentInfo WHERE Special = -1"
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command10_Grouping"
      Expanded        =   -1  'True
      IsRSReturning   =   -1  'True
      NumFields       =   6
      BeginProperty Field1 
   ...
   BeginProperty Recordset12 
      ...
      CommDispId      =   1073
      RsDispId        =   1080
      CommandText     =   $"DataEnvironment1.dsx":0096
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command11_Grouping"
      Expanded        =   -1  'True
      DetailExpanded  =   -1  'True
      IsRSReturning   =   -1  'True
      NumFields       =   7
   ...
   BeginProperty Recordset13 
      ...
      CommDispId      =   1081
      RsDispId        =   1083
      CommandText     =   "SELECT MatricNumber, LastName, FirstName, Department, tblLevel, Sex FROM StudentInfo WHERE Sex = 'Male'"
      ActiveConnectionName=   "conYCT"
      CommandType     =   1
      Grouping        =   -1  'True
      GroupingName    =   "Command12_Grouping"
      Expanded        =   -1  'True
      SummaryExpanded =   -1  'True
      DetailExpanded  =   -1  'True
      IsRSReturning   =   -1  'True
